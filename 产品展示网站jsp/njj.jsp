    ...
    <div class="liebiao_left">
        ...
        <div class="liebiao_fenlei">
            <dl>
                ...
                <dt><a  href="bjq.jsp">背涂胶</a></dt>
        
                <dt><a  href="zcj.jsp">真瓷胶</a></dt>

                <dt class='hover'><a href='njj.jsp'>粘结剂（瓷砖胶）</a></dt>
    ...
    <div class="liebiao_right">
        <div class="liebiao_right_biaoti">
            ...
            2.后面是某一类别所有的产品列表。需要图片和名称
             -->
            <h1>粘结剂（瓷砖胶）<span class="fr">当前位置：<a href='index.jsp'>主页</a> > <a href=#'>产品中心</a> >  </span></h1>
        </div>
        ...
        <div class="articleBox">
            <ul>
                ...
                try
                {
                    ...
                    String sql = "SELECT * FROM source where typeid='5' " ;
