    ...
    <div class="liebiao_left">
        ...
        <div class="liebiao_fenlei">
            <dl>    
                ...
                <dt class='hover'><a href='zcj.jsp'>真瓷胶</a></dt>
    ...
    <div class="liebiao_right">
        <div class="liebiao_right_biaoti">
            ...
            2.后面是某一类别所有的产品列表。需要图片和名称
             -->
            <h1>真瓷胶<span class="fr">当前位置：<a href='index.jsp'>主页</a> > <a href=#'>产品中心</a> >  </span></h1>
        </div>
        ...
        <div class="articleBox">
            <ul>
                ...
                try
                {
                    ...
                    String sql = "SELECT * FROM source where typeid='4' " ;
