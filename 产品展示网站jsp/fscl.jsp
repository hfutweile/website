    ...
    <div class="liebiao_left">
        ...
        <div class="liebiao_fenlei">
            <dl>    
                ...
                <dt class='hover'><a href='fscl.jsp'>防水材料</a></dt>
    ...
    <div class="liebiao_right">
        <div class="liebiao_right_biaoti">
            ...
            2.后面是某一类别所有的产品列表。需要图片和名称
             -->
            <h1>防水材料<span class="fr">当前位置：<a href='index.jsp'>主页</a> > <a href=#'>产品中心</a> >  </span></h1>
        </div>
        ...
        <div class="articleBox">
            <ul>
                ...
                try
                {
                    ...
                    String sql = "SELECT * FROM source where typeid='2' " ;
