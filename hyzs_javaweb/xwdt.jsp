...
try
{
    ...
    String sql = "SELECT news_id,news_title,news_picture,news_time FROM news where news_type='xw' ORDER BY news_time DESC limit 5" ;
        ...
        <div class="main_news">
            <ul>
                ...
                <li>
                    ...
                    <div class="content">
                        <s><%=news_time%></s>
                        <!--<a href="newsdemo.html">红云智胜科技有限公司参加CIT2018会议</a>-->
                        <form action="newsdemo.jsp" method="post">
...
%> 
        ...
        <div class="web_pages">
            <ul class="pagelist">
                <li><a href='xwdtmore.jsp'>点击加载更多</a></li>
