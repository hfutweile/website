...
try
{
    ...
    String sql = "SELECT news_id,news_title,news_picture FROM news" ;
            ...
            <ul>
                <li>
                        ...
                        <form action="newsdemo.jsp" method="post">
                            ...
                            <input type='image' src="style/images/<%=news_picture1%>" alt="submit" >
                        </form>
                        <div class="fr">
...
<!--
        <div class="web_pages">
            <ul class="pagelist">
                <li><a href=''>下一页</a></li>
                <li class="thisclass"><a href="#">上一页</a></li>
-->
